              ...
              {phaseData.items.map((item, iIdx) => {
                ...
                return (
                  ...
                  <AnimatedCard key={key} delay={iIdx * 50}>
                    <div
                      className={`group relative rounded-2xl p-4 md:p-6 flex 
                        flex-col sm:flex-row gap-4 items-start sm:items-center border hover:bg-emerald-950/20 transition-all duration-150 ${
                          isDone
